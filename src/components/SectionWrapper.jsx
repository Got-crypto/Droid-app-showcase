...
export default function SectionWrapper({title, reverse, description, banner, showBtn, mockupImg}){
    return (
                ...
                `}>
                    ...
                    {showBtn && (
                        <Button 
                            ...
                            link="https://expo.dev/@gerrardafk/droid-app?serviceType=classic&distribution=expo-go"
                        />
                    )}
